              ...
              <div className="screen_out">
                <div className="screen_out1">
                  <div className="screen">
                    <span className="notfound_text">Coming Very Soon </span>
                  </div>
                  <div className="screenM">
                    <span className="notfound_text"> Very soon</span>
                  </div>
                </div>
              </div>
            </div>
...
const StyledWrapper = styled.div`
  /* 💡 This wrapper ensures perfect centering of the entire animation */
  width: 100vw;
  height: 100vh;
  display: flex;
