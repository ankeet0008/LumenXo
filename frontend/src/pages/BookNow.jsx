...
const ContactLumenXo = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 flex items-center justify-center px-6 py-10">
      <div className="bg-white shadow-md rounded-xl max-w-3xl w-full p-8 border border-indigo-200">
