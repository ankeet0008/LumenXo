...
const FeaturedIn = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `url('https://img.freepik.com/premium-vector/torn-newspaper-border-banner-jagged-edges-collage-halftone-elements-frame-place-fo-text-concept-from-paper-scraps-white-background-trendy-design-template-vector-illustration_190776-4510.jpg?semt=ais_hybrid&w=740&q=80')`,
        transform: "rotate(180deg)", // rotates background
      }}
    >
      <div className="max-w-4xl mx-auto px-6 text-center" style={{ transform: "rotate(180deg)" }}>
        {/* rotate content back to normal */}
          ...
          <div className="flex justify-center items-center w-full">
            {newspapers[index].logo ? (
              <img
                ...
                className="h-64 w-auto mx-auto" // increased height
              />
            ) : (
