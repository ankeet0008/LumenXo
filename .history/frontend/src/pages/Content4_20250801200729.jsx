Thank you for clarifying. It seems I misunderstood and provided a new component with a different design. My apologies.

I will update the original `ServicesPage` component, keeping its existing structure and styles, and only change the data within the `servicesData` array.

Here is the updated code with the new service data you provided previously (from the `styled-components` example) applied to the original React + Tailwind component.
...
const ServicesPage = () => {
  const servicesData = [
    {
      // Using a simplified icon to represent the emoji 🏢
      icon: (
    ...
    {
      // Using a simplified icon to represent the emoji ⚙️
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
