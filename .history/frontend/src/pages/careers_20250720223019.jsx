...
const Careers = () => {
  ...
  type: 'Internship',
  experience: 'Fresher',
  description: 'Join our engineering team as a Full Stack Intern to gain hands-on experience building scalable web applications using modern technologies. Work alongside experienced developers and contribute to real-world projects.',
  requirements: [
   ...
   
{
  ...
  salary: '$18-25/hour',
  experience: 'Fresher',
  description: 'Learn UI/UX design fundamentals while working on real projects. Gain hands-on experience in user research, wireframing, and interface design under mentorship of senior designers.',
  requirements: [
...

{
  ...
  salary: '$15-20/hour',
  experience: 'Fresher',
  description: 'Develop graphic design skills while creating visual content for marketing campaigns. Learn brand guidelines and design best practices in a professional environment.',
  requirements: [
    'Currently pursuing degree in Graphic Design or related field',
  ...
  responsibilities: [
    'Create social media graphics under guidance',
    'Assist with marketing material design',
...

{
  ...
  salary: '$16-22/hour',
  experience: 'Fresher',
  description: 'Learn video editing and post-production techniques while working on content projects. Gain experience with professional editing software and video production workflows.',
  requirements: [
    'Currently pursuing degree in Film, Media, or related field',
    'Basic knowledge of video editing software',
    'Understanding of video production concepts',
    'Creative mindset and storytelling interest',
    'Portfolio of video projects (academic or personal)'
  ],
  responsibilities: [
    'Assist with basic video editing tasks',
    'Learn color correction and audio editing',
    'Support content creation projects',
