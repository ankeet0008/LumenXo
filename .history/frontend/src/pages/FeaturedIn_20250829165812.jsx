...
const FeaturedIn = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `url('https://media.gettyimages.com/id/1173905761/video/gray-abstract-minimal-motion-backgrounds-loopable-elements-4k-resolution.jpg?s=640x640&k=20&c=SufjBIhB791a7uD3FtTrIkAfXaGhgfFqra0fdzuAuLw=')`,
      }}
    >
