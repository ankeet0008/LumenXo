  ...
  return (
    <section className="bg-[#f4f8ff] py-16 px-4 md:px-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        {/* Left Section */}
        <div>
          <p className="text-[#4f46e5] font-semibold mb-2">Enterprise Product Development, AI & Data Engineering Experts | Radixweb</p>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md col-span-2">
            ...
            <div className="h-32 flex justify-center items-center bg-gray-50 rounded-md overflow-hidden">
              <img
                src="https://images.unsplash.com/photo-1611224923853-80b023f02d71?w=600&h=200&fit=crop&crop=center"
