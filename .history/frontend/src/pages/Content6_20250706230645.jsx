      ...
      <div className="relative max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        >
          ...
          >
            ...
            <motion.div
              className="absolute top-10 -right-5 w-12 h-12  rounded-full flex items-center justify-center shadow-lg"
              animate={{
                y: [-5, 5, -5],
                rotate: [0, 10, 0],
              }}
            ...
            <motion.div
              className="absolute bottom-10 -left-5 w-12 h-12  rounded-full flex items-center justify-center shadow-lg"
              animate={{
                y: [5, -5, 5],
                rotate: [0, -10, 0],
              }}
        ...
        >
          ...
          >
            <motion.div
              ...
              transition={{ duration: 0.3 }}
            >
              <span className="px-4 py-2  text-sm font-semibold rounded-full border border-indigo-200">
                Why Choose Us
              </span>
            </motion.div>
