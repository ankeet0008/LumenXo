...
const Navbar = () => {
  ...
  return (
    <>
      {/* 🔷 Top Header */}
      <div className="bg-gradient-to-r from-[#03233d] to-[#3783b5] text-white text-sm px-4 py-2 flex flex-col md:flex-row justify-between items-center gap-2">
        {/* Left - Contact Info */}
        <div className="flex flex-wrap items-center gap-4">
          <div className="flex items-center gap-1">
            <FaPhone className="text-blue-300" />
            <span>7978788529</span>
          </div>
          <div className="flex items-center gap-1 border-l border-white pl-4">
            <FaEnvelope className="text-blue-300" />
            <span>contact@aioninnotech.com</span>
          </div>
          <div className="flex items-center gap-1 border-l border-white pl-4">
            <FaMapMarkerAlt className="text-blue-300" />
            <span>Plot No : 247/A, Saheed Nagar, Bhubaneswar, Odisha</span>
          </div>
        </div>

        {/* Right - Social Icons */}
        <div className="flex gap-2 mt-2 md:mt-0">
          <a href="#" className="bg-white text-blue-900 rounded-full p-2 hover:scale-110 transition">
            <FaFacebookF />
          </a>
          <a href="#" className="bg-white text-blue-900 rounded-full p-2 hover:scale-110 transition">
            <FaTwitter />
      ...
      {/* 🔷 Main Navigation Bar */}
      <motion.nav className="fixed top-[40px] left-0 right-0 z-50 bg-white text-black border-b shadow-md">
      ...
      {/* Spacer below fixed navbar and header */}
