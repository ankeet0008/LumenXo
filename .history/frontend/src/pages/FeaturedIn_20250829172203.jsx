...
const FeaturedIn = () => {
  ...
  Featured In
        ...
        <div className="relative flex justify-center items-center">
          <button
            onClick={prevSlide}
            className="absolute left-0 text-white p-2 rounded-full text-white  hover:bg-gray-200"
          >
            <ChevronLeft />
          </button>
          ...
          <button
            onClick={nextSlide}
            className="absolute right-0 p-2 rounded-full text-white  hover:bg-gray-200"
          >
            <ChevronRight />
          </button>
        </div>
