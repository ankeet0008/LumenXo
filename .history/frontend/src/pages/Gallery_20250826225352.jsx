...
const GallerySlider = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://coolbackgrounds.imgix.net/4BIP4ge9ontCTkNubiY4lb/48121f9d09134fd83670b1d6e182aa66/white-particles-background.png?w=3840&q=60&auto=format,compress')",
      }}
    >
