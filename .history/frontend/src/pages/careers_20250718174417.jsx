          ...
          <div className="relative max-w-7xl mx-auto px-6 py-20 lg:py-32">
            <div className="text-center">
              <div className="inline-flex items-center bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-6 py-3 mb-8">
                <Briefcase className="w-5 h-5 text-white mr-3" />
              ...
              <p className="text-xl text-blue-100 max-w-3xl mx-auto mb-12 leading-relaxed">
                Join a team of passionate professionals who are shaping the future of technology. 
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
                <button 
                  ...
                  className="bg-white text-blue-900 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-gray-100 transition-all duration-300 shadow-xl"
                >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
                <div className="text-center">
                  ...
                  <div className="text-blue-200 text-sm uppercase tracking-wide">Employees</div>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <div className="text-blue-200 text-sm uppercase tracking-wide">Retention Rate</div>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-bold text-white mb-2">4.8★</div>
                  <div className="text-blue-200 text-sm uppercase tracking-wide">Glassdoor Rating</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gray-900 py-20">
          <div className="max-w-4xl mx-auto text-center px-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="border-2 border-gray-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-gray-800 transition-all duration-300">
                Schedule a Call
              </button>
            </div>
          </div>
        ...
        <footer className="bg-white border-t border-gray-200 py-12">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Careers</h3>
                <ul className="space-y-2 text-sm text-gray-600">
                  <li><a href="#" className="hover:text-gray-900">Open Positions</a></li>
                  <li><a href="#" className="hover:text-gray-900">Life at Company</a></li>
                  <li><a href="#" className="hover:text-gray-900">Diversity & Inclusion</a></li>
                  <li><a href="#" className="hover:text-gray-900">University Recruiting</a></li>
                </ul>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="mt-4">
                  <p className="text-sm text-gray-600 mb-2">Stay updated with our latest opportunities</p>
                  <div className="flex">
                    <input
                      type="email"
