		...
		<form noValidate onSubmit={handleSubmit}>
			<div className="mb-4">
				<input
					...
					name="name"
					required
					className="min-h-[48px] leading-[48px] bg-[#F2F6FD] border border-transparent rounded-xl focus:outline-none focus:border-[#86b7fe] w-full px-5"
...
const ContactFormCard = () => (
	<div className="bg-white text-black rounded-2xl border-[25px] border-[#F4F7FD] p-6 md:p-12">
