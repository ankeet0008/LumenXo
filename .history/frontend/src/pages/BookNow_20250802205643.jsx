  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="relative bg-k bg-opacity-95 rounded-lg w-full max-w-xs sm:max-w-sm md:max-w-md p-4 sm:p-6 md:p-8 border border-gray-200 z-10 mx-4 h-[350px] sm:h-[400px] md:h-[450px] flex flex-col justify-center"
          style={{
