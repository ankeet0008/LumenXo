      ...
      <div className="bg-black text-white min-h-screen px-6 sm:px-12 lg:px-20 py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="flex justify-center">
            <img
              src="https://upload.wikimedia.org/wikipedia/commons/6/6a/Accenture_Illustration.svg" 
          ...
          <div>
            ...
            <p className="text-gray-300 mb-6">
              Thanks for your interest in LumenXo. Choose from the options below
        ...
        <div className="mt-16">
          ...
          <form className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <input
              ...
              className="p-3 rounded-md bg-gray-800 text-white border border-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-500 sm:col-span-2"
            />
            <textarea
            ...
            <button
              type="submit"
              className="bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-md transition sm:col-span-2"
            >
              Send
            </button>
          </form>
