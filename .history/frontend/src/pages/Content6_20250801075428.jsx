...
export default function WhyLumenXo() {
  return (
    <section
      ...
      style={{
        backgroundImage: `url('https://cdn.pixabay.com/photo/2022/01/29/21/39/background-6978960__480.jpg')`,
      }}
    >
      {/* Optional: Add a light background overlay for better readability */}
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 bg-white bg-opacity-80 backdrop-blur-sm p-8 rounded-xl">
        {/* Left Side Image */}
