...
const Careers = () => {
 ...
 const jobOpenings = [
  ...
  },
  {
    ...
    salary: '$14-18/hour',
    experience: 'Fresher',
    description: 'Learn digital marketing fundamentals while supporting marketing campaigns during our 60-day internship program. Gain experience in social media marketing, content creation, and analytics.',
    requirements: [
      ...
      'Eagerness to learn about marketing tools and platforms'
    ],
    responsibilities: [
      ...
      'Participate in campaign planning and brainstorming',
    ...
    benefits: [
      ...
      'Campaign strategy learning opportunities',
      'Analytics and reporting experience',
      'Professional marketing mentorship',
  ...
  },
  {
    ...
    salary: '$18-24/hour',
    experience: 'Fresher',
    description: 'Learn data analysis and visualization techniques during our 60-day internship program. Work with real datasets to generate insights and support data-driven decision making.',
    requirements: [
      'Currently pursuing degree in Data Science, Statistics, Mathematics, or related field',
      'Basic knowledge of Excel and data analysis concepts',
      'Some exposure to SQL or Python (preferred but not required)',
      'Strong analytical and problem-solving skills',
      'Interest in working with data and generating insights',
      'Good attention to detail and accuracy',
      'Willingness to learn new tools and technologies'
    ],
    responsibilities: [
      'Assist with data collection, cleaning, and preparation',
      'Learn to create reports and data visualizations',
      'Support business intelligence and reporting initiatives',
      'Participate in data analysis projects under supervision',
      'Help maintain data quality and documentation',
      'Learn to use analytics tools and platforms',
      'Contribute to data-driven insights and recommendations'
    ],
    benefits: [
      'Analytics tools and software access',
      'Real-world data analysis experience',
      'Business intelligence learning opportunities',
      'Data visualization skill development',
      'Statistical analysis training',
      'Professional analytics mentorship',
      'Certificate of completion'
    ],
    icon: PieChart,
    color: 'teal',
  ...
  },
  {
    ...
    salary: '$12-16/hour',
    experience: 'Fresher',
    description: 'Develop content writing skills while creating engaging content for various platforms during our 60-day internship program. Learn content strategy and SEO best practices.',
    requirements: [
      'Currently pursuing degree in English, Journalism, Communications, or related field',
      'Strong writing and grammar skills',
      'Basic understanding of content marketing principles',
      'Familiarity with different content formats and styles',
      'Research skills and ability to write on various topics',
      'Interest in digital content and online publishing',
      'Creativity and ability to adapt writing style'
    ],
    responsibilities: [
      'Write blog posts, articles, and web content under guidance',
      'Assist with content planning and editorial calendar',
      'Learn SEO writing techniques and keyword optimization',
      'Support social media content creation',
      'Participate in content brainstorming and strategy sessions',
      'Help with content editing and proofreading',
      'Learn content management system usage'
    ],
    benefits: [
      'Professional writing experience',
      'Content strategy learning opportunities',
      'SEO and digital marketing exposure',
      'Editorial process understanding',
      'Content creation tool access',
      'Writing mentorship and feedback',
      'Certificate of completion'
    ],
    icon: BookOpen,
    color: 'yellow',
  ...
  },
  {
    ...
    salary: '$15-20/hour',
    experience: 'Fresher',
    description: 'Learn business development fundamentals while supporting partnership and growth initiatives during our 60-day internship program. Gain experience in market research and business strategy.',
    requirements: [
      ...
      'Basic understanding of business development concepts',
    ...
    responsibilities: [
      ...
      'Learn CRM system usage and data management',
      'Participate in business strategy discussions',
      'Support partnership development initiatives',
      'Contribute to business process improvement projects'
    ],
    benefits: [
