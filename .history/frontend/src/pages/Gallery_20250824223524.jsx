...
const galleryItems = [
  {
    img: "https://static.vecteezy.com/system/resources/thumbnails/048/925/895/small_2x/green-back-to-school-background-with-line-scribble-style-on-blackboard-free-copy-space-area-suitable-for-banners-and-posters-vector.jpg",
    title: "Peaceful Lake",
...
const GallerySlider = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://png.pngtree.com/thumb_back/fw800/background/20210612/pngtree-fun-cartoon-elementary-education-image_728852.jpg')",
      }}
    >
      <section className="bg-white/35 backdrop-blur-md rounded-2xl shadow-lg p-8 md:p-12 max-w-6xl w-full">
