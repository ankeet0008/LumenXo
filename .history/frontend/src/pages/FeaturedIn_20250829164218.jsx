...
const FeaturedIn = () => {
  ...
  className="h-32 w-auto mx-auto grayscale opacity-60 hover:opacity-100 transition"
/>
            ) : (
              <span className="text-xl font-semibold hover:opacity-100 transition">
          ...
          <button
            onClick={nextSlide}
            className="absolute right-0 p-2 rounded-full hover:bg-gray-300"
          >
            <ChevronRight />
          </button>
        </div>
