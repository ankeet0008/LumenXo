...
export default function StatsSection() {
  ...
  return (
    <section
      ref={ref}
      className="relative bg-cover bg-center bg-no-repeat min-h-[350px] md:min-h-[450px] py-16 px-6"
      style={{
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-10 text-center p-6">
