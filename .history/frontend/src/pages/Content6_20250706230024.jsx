...
const FloatingElement = ({ delay = 0, className = "" }) => (
  <motion.div
    className={`absolute w-3 h-3 bg-gradient-to-r from-indigo-400 to-purple-500 rounded-full opacity-20 ${className}`}
    animate={{
      y: [-10, -30, -10],
      x: [-5, 5, -5],
      opacity: [0.2, 0.6, 0.2],
...
export default function WhyLumenXo() {
  return (
    <section className="relative py-20 px-6 bg-gradient-to-br from-slate-50 via-white to-indigo-50 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Gradient Orbs */}
        <motion.div
          className="absolute -top-20 -right-20 w-80 h-80 bg-gradient-to-br from-indigo-200/30 to-purple-300/20 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.3, 1],
            opacity: [0.3, 0.5, 0.3],
          }}
