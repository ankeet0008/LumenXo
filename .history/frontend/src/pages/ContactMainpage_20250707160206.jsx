...
const ContactForm = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // You can add form submission logic here (e.g., send data to backend)
    setSubmitted(true);
    setName('');
    setEmail('');
    setPhone('');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 font-sans">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('https://plus.unsplash.com/premium_photo-1684120269169-0ab71068e058?q=80&w=764&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA==')",
        }}
      >
        ...
        <div className="max-w-4xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 text-gray-700">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p>123 Tech Street, Innovation City, 45678</p>
            </div>
          </div>
          <div className="flex items-start gap-4">
