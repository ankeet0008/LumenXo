      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <img 
              src='https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=400&h=300&fit=crop&crop=' 
          ...
          <div className="bg-white p-6 rounded-lg shadow-md flex flex-col">
            <img 
              src='https://thumbs.dreamstime.com/b/graph-upward-arrow-white-background-depicts-growth-progress-graph-upward-arrow-white-background-depicts-growth-316959429.jpg' 
          ...
          <div className="  rounded-lg shadow-md col-span-5">
            
            <div className="h-32 flex justify-center items-center rounded-md overflow-hidden">
              <img
                src="https://www.techtarget.com/visuals/searchContentManagement/collaboration_technology/contentmanagement_article_003_searchsitetablet_520X173.jpg"
