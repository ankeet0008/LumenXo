...
const ContactFormCard = () => (
	<div className="bg-white  rounded-2xl border-[25px] text-black border-[#F4F7FD] p-6 md:p-12">
...
const ContactUs11 = () => {
	return (
		<section className="ezy__contact11 light bg-white  text-white dark:text-white overflow-hidden">
			<div
