    ...
    <section className="py-20 bg-gradient-to-br from-white via-slate-50 to-violet-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="relative z-10 rounded-xl overflow-hidden shadow-xl border border-violet-200">
            <img
          ...
          <div className="absolute -bottom-12 -right-12 w-2/3 rounded-xl overflow-hidden shadow-lg border border-purple-100 hidden sm:block">
            <img
