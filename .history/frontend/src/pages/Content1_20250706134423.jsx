      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <motion.p
            ...
            transition={{ delay: 0.8, duration: 1 }} // Increased delay and duration
          ...
          <motion.button
            ...
            transition={{ delay: 1.6, duration: 0.8 }} // Button comes last
        ...
        <motion.div
          ...
          animate={{ x: 0, opacity: 1 }}
          transition={{ delay: 0.6, duration: 1.2 }} // Slow slide-in
        >
          <img
            src={heroImage}
