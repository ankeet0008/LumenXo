...
<section className="bg-white py-12 px-6">
  <div className="max-w-7xl mx-auto text-center">
    ...
    <p className="text-lg text-gray-700 mb-6">
      We are proud to be a <strong>certified and verified company</strong> recognized for our quality, compliance, and excellence in software solutions.
    </p>
    <div className="flex flex-wrap justify-center items-center gap-8">
      ...
      />
      <img
        src="https://t3.ftcdn.net/jpg/04/74/19/94/360_F_474199429_m6TfIkF9oVjqC267jT9tcNSn3IkRIi6e.jpg"
        alt="Certification 2"
        className="h-24 object-contain"
      />
      <img
