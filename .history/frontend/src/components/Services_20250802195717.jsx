      ...
      <div ref={headerRef} className="text-center mb-20">
        <div className={`transform transition-all duration-700 ${headerVisible ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'}`}>
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            We are determined to help you reach your business goals. LumenXo is a
...
>
  <div className=" bg-opacity-90 rounded-2xl p-10  max-w-4xl mx-auto">
    ...
    <button className="px-8 py-4 bg-blue-600 hover:bg-blue-700 text-wi font-semibold rounded-xl transition-all duration-300 hover:shadow-lg transform hover:-translate-y-0.5">
