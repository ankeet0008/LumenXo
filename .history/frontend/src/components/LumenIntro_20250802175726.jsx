...
const LumenIntro = () => {
  return (
    ...
    >
      ...
      <div className="md:w-1/2 text-w space-y-6">
        <h1 className="text-4xl md:text-5xl font-bold">
          Welcome To <span className="text-yellow-400">LumenXo.</span>
        </h1>
        ...
        <button className="mt-4 bg-yellow-400 text-black py-3 px-6 rounded-lg hover:bg-yellow-500 transition">
          DISCOVER MORE
        </button>
      </div>
