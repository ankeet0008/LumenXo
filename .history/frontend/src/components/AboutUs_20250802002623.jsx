  ...
  return (
    <div className="flex flex-col">
      ...
      <section
        ...
        style={{ backgroundImage: `url('https://wallpaperaccess.com/full/1385382.jpg')` }}
      >
      ...
      <section className="flex flex-col md:flex-row-reverse items-center gap-10 px-6 md:px-20 py-16">
        <img
          src="https://cdn.pixabay.com/photo/2017/08/01/08/29/people-2569234_960_720.jpg"
          alt="Mission"
          className="w-full md:w-1/2 rounded-lg shadow-lg"
        />
        <div className="md:w-1/2">
          <h2 className="text-3xl font-bold text-indigo-700 mb-4 flex items-center gap-2">
            <Target className="w-6 h-6 text-indigo-500" /> Our Mission
          </h2>
          <p className="text-lg">
      ...
      <section className="flex flex-col md:flex-row items-center gap-10 px-6 md:px-20 py-16 bg-gray-100">
        <img
          src="https://cdn.pixabay.com/photo/2018/01/18/07/32/idea-3085367_960_720.jpg"
          alt="Vision"
          className="w-full md:w-1/2 rounded-lg shadow-lg"
        />
        <div className="md:w-1/2">
          <h2 className="text-3xl font-bold text-indigo-700 mb-4 flex items-center gap-2">
            <Eye className="w-6 h-6 text-indigo-500" /> Our Vision
          </h2>
          <p className="text-lg">
      ...
      <section className="flex flex-col md:flex-row-reverse items-center gap-10 px-6 md:px-20 py-16">
        <img
          src="https://cdn.pixabay.com/photo/2020/04/02/14/06/startup-4992754_1280.jpg"
          alt="Why Choose Us"
          className="w-full md:w-1/2 rounded-lg shadow-lg"
        />
        <div className="md:w-1/2">
          <h2 className="text-3xl font-bold text-indigo-700 mb-4 flex items-center gap-2">
            <Lightbulb className="w-6 h-6 text-indigo-500" /> Why Choose Us?
          </h2>
