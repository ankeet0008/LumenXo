...
const LumenxoCompanyPage = () => {
  return (
    <div className="font-sans">
      ...
      <section className="relative h-[80vh] bg-cover bg-center" style={{ backgroundImage: `url('https://cdn.pixabay.com/photo/2018/06/08/00/48/developer-3461405_1280.png')` }}>
