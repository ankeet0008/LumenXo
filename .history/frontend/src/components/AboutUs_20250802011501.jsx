...
const AboutPage = () => {
  return (
    <div className="flex flex-col">
      ...
      {/* ABOUT SECTION */}
      <section
        className="flex flex-col md:flex-row items-center justify-between px-6 md:px-20 py-16 bg-cover bg-center bg-no-repeat text- relative"
        style={{ backgroundImage: `url('https://png.pngtree.com/thumb_back/fh260/back_our/20190620/ourmid/pngtree-program-development-programming-hd-background-image_161259.jpg')` }}
      >
