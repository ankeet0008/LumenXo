        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-10">
          ...
          <div className="w-full lg:w-1/2 text-white space-y-6">
            ...
            <div>
              ...
              <p className="text-lg leading-relaxed">
                LumenXo was establishment on <strong>Novemember 14th </strong> officially incorporated on <strong>April 16, 2025</strong>. We're specialists in full-stack development, automation, and digital strategy—delivering exceptional outcomes for ambitious clients.
              </p>
            </div>
