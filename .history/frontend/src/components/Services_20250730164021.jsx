...
// Your services data (unchanged)
const services = [/* same as your original array */];
...
const OurProcess = () => (
  <section className="w-full py-20 bg-gradient-to-r from-[#0a0a12] to-[#0b0b1a] text-white text-center px-4 mb-20">
