  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="flex flex-col md:flex-row-reverse items-center gap-10 px-6 md:px-20 py-16">
        <img
          src="https://static.vecteezy.com/system/resources/previews/017/398/047/non_2x/futuristic-mission-concept-an-arrow-and-darts-target-glowing-symbols-and-text-technology-abstract-mission-illustration-graphic-design-concept-of-business-mission-glow-in-the-dark-background-vector.jpg"
          alt="Mission"
          className="w-full md:w-1/2 rounded-lg shadow-lg"
        />
        <div className="md:w-1/2">
